...
const headCells = [
    ...
    { id: 'symptoms', numeric: false, disablePadding: false, label: 'Symptoms' },
    { id: 'comments', numeric: true, disablePadding: false, label: 'Comments' },
    { id: 'consultDate',  numeric: false, disablePadding: false, label: 'Consult Date' },
    { id: 'consultTime',  numeric: false, disablePadding: false, label: 'Consult Time' },
    { id: 'currentStatus', numeric: false, disablePadding: false, label: 'Current Status' }
];
...
function ListAppointments() {
    ...
    const getAppointment = useCallback(() => {
            AdminService.getAppointments(records)
            .then(data => {
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">{row.student.id}</TableCell>
                                            <TableCell align="right">{row.symptoms}</TableCell>
                                            <TableCell align="right">{row.comment}</TableCell>
                                            <TableCell align="right">{row.date}</TableCell>
                                            <TableCell align="right">{row.timeAllocated}</TableCell>
