...
function HeaderDoc(){
  ...
  const renderMobileMenu1 = (
    ...
    >
      ...
      <MenuItem>
        <Link href="/student" underline='none'>           
          <p style={{color: '#606264', fontWeight: 'bold'}}>Student details</p>
        </Link>
       </MenuItem>


      <MenuItem>
        <Link href="/addPres" underline='none'>     
          ...
          <Toolbar>
            <Grid container>
              ...
              <Grid item className={classes.sectionMobile}>
                ...
                <Link to="/doctor/" underline='none' >      {/*-------------Change these Links------------ */}
                  <Typography className={classes.Typography}>
                    <FontAwesomeIcon icon={faLaptopMedical} />
                    {" "}MedManager
                  </Typography>
              ...
              <Grid item className={classes.sectionDesktop}>
                <Typography className={classes.Typography} >
                  <Link to="/doctor/appoint/" underline='none' className={classes.Link} role="button">    
                    Appointments
                  </Link>
                  <Link to="/doctor/student/" underline='none' className={classes.Link} role="button">    
                    Student details
                  </Link>
                 
                  <Link to="/doctor/addPres/" underline='none' className={classes.Link} role="button">
                    Prescription
                  </Link>
